...
class OfflineMails extends StatefulWidget {
  const OfflineMails({Key? key}) : super(key: key);

  @override
  _OfflineMailsState createState() => _OfflineMailsState();
}

class _OfflineMailsState extends State<OfflineMails> {
  ...
  Widget build(BuildContext context) {
    if(mails.isEmpty) return Scaffold(
        ...
        appBar: PreferredSize(preferredSize: Size.fromHeight(60.0),
            child: CustomAppBar("Offline Emails",true)),
        body: EmptyPage(),
